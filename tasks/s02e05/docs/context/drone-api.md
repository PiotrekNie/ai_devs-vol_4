# DRN-BMB7 — snapshot dokumentacji API (author reference)

> **Snapshot date:** 2026-05-27  
> **Source URL:** https://hub.ag3nts.org/dane/drone.html  
> **Disclaimer:** Reference for authors, prompt review, and tests only. **The agent must fetch live HTML via `http_request` at runtime** — do not treat this file as authoritative during homework.
