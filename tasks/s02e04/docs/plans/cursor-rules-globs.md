...
- Normalise `globs` in [`.cursor/rules/eversis-accessibility.mdc`](/third-party/github-collections/.cursor/rules/eversis-accessibility.mdc) (after verifying the format in Cursor).
- **Documentation:** brief explanation — `alwaysApply: true` (no globs), file-scoped rules (YAML list `globs`), prompt-attached rules (empty `globs`, attach with `@`) — in [`documentation/cursor-collection.md`](/third-party/github-collections/documentation/cursor-collection.md) and/or the skills [`eversis-creating-agents`](/third-party/github-collections/.cursor/skills/eversis-creating-agents/SKILL.md) / [`eversis-creating-instructions`](/third-party/github-collections/.cursor/skills/eversis-creating-instructions/SKILL.md), without artificial duplication.
- **[`README.md`](/third-party/github-collections/README.md):** concise update — mention of `.mdc` frontmatter consistent with the framework doc.
- **[`CHANGELOG.md`](/third-party/github-collections/CHANGELOG.md):** _Added_ / _Changed_ entries under the deployment date + mirrored to [`website/src/pages/changelog.md`](/third-party/github-collections/website/src/pages/changelog.md).
- **Website:** after changing [`documentation/cursor-collection.md`](/third-party/github-collections/documentation/cursor-collection.md) — `npm run build` in `website/` and commit [`website/docs/framework-reference.md`](/third-party/github-collections/website/docs/framework-reference.md).
...
- **`eversis-accessibility.mdc`:** globs already existed as a single comma-separated string. Normalised to a YAML list following the [`scoped-conventions.template.md`](/third-party/github-collections/.cursor/skills/eversis-creating-instructions/assets/scoped-conventions.template.md) template.
