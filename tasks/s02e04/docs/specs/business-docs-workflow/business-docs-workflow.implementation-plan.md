...
**Dokumentacja frameworka (Cursor Collections):** [documentation/cursor-collection.md](/third-party/github-collections/../documentation/cursor-collection.md)
...
| B5  | [REUSE]  | Walidacja spójności z [eversis-creating-prompts](/third-party/github-collections/../.cursor/skills/eversis-creating-prompts/SKILL.md) i [eversis-creating-agents](/third-party/github-collections/../.cursor/skills/eversis-creating-agents/SKILL.md) — krótkie reguły, SOP w promptach. |
...
| C2  | [MODIFY] | [AGENTS.md](/third-party/github-collections/../AGENTS.md) i/lub `[.cursor/mcp.json](/third-party/github-collections/../.cursor/mcp.json)` — wpis dokumentacyjny + instrukcja buildu; **bez** commitowania sekretów.           |
...
- **IDE-CFG-01** — W _Cursor Settings → MCP_ włączyć **Atlassian** (Jira + Confluence) dla przestrzeni z dokumentacją projektu; potwierdzić logowanie / token zgodnie z polityką firmy.
- **IDE-CFG-02** — Włączyć wpis **`eversis-collections`** w `[.cursor/mcp.json](/third-party/github-collections/../.cursor/mcp.json)` (stdio → `mcp/eversis-collections-mcp/dist/index.js`) po `npm install && npm run build` w [eversis-collections-mcp](/third-party/github-collections/../mcp/eversis-collections-mcp/); **zrestartować** serwery MCP w Cursorze po zmianie JSON.
- **IDE-CFG-03** — Zbudować [eversis-collections MCP](/third-party/github-collections/../mcp/eversis-collections-mcp/) przed użyciem Agenta: obejmuje zarówno `eversis_skills_*` (**B5**), jak i narzędzia `.docx` dla Writer.
- **IDE-CFG-04** — Upewnić się, że w _Cursor Settings → Indexing / Docs_ nie indeksujesz duplikatów promptów: w tym monorepo `website/docs/prompts/` jest w `[.cursorignore](/third-party/github-collections/../.cursorignore)` — **SSOT to `.cursor/prompts/`**.

**Implementacja w repozytorium (mapowanie na §3)**

- **A1** — Zmiana `documentation/cursor-collection.md`: wariant _Business / regulatory docs (.docx)_.
...
- **B5** — Nawigować Agentem do skilli [eversis-creating-prompts](/third-party/github-collections/../.cursor/skills/eversis-creating-prompts/SKILL.md) / [eversis-creating-agents](/third-party/github-collections/../.cursor/skills/eversis-creating-agents/SKILL.md); poprawić reguły/prompty tak, by nie duplikować długich SOP w `.mdc`.
...
- **IDE-CMD-01** — (Opcjonalnie) Cienkie pliki `[.cursor/commands/](/third-party/github-collections/../.cursor/commands/)` (`eversis-ba-docs-planner.md`, `eversis-ba-docs-writer.md`) wzorowane na `[eversis-implement.md](/third-party/github-collections/../.cursor/commands/eversis-implement.md)`, aby wywoływać flow z **/** w Chat/Agent.
...
> **Uwaga:** Ten tor **nie** wymaga podawania URL dev servera ani `eversis-review-ui` — inaczej niż frontendowy playbook z `[eversis-implement.md](/third-party/github-collections/../.cursor/prompts/public/eversis-implement.md)`.
...
- Da się uruchomić workflow przez `**@`\*\* + stem zgodnie z [AGENTS.md](/third-party/github-collections/../AGENTS.md) (prompty publiczne + ewentualnie jawne dołączenie reguł).
...
1. **Komentarz recenzenta Worda** (_Recenzja → Komentarz_) — balon z boku, autor, często powiązanie z zakresem; typowy dla trybu recenzji.
