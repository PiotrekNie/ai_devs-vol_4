...
- Technical architecture or implementation details (use the **Architect** agent for that)
- Detailed acceptance criteria from a QA perspective (use the **Context Engineer** agent for that)
