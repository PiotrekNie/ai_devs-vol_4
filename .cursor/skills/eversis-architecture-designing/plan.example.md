...
#### Task 2.2 - [REUSE] UI Verification of <ui-component-name> by the UI Reviewer

**Description**: Run the **UI Reviewer** (attach `eversis-review-ui.md`) to verify <ui-component-name> against Figma design. Pass the Figma URL and dev server URL. If verification fails, delegate fix to the **Software Engineer** and re-verify (max 5 iterations per component).
