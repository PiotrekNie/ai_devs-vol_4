---
name: eversis-implementing-kubernetes
...
- `eversis-implementing-observability` - For K8s monitoring and logging setup
- `eversis-implementing-ci-cd` - For K8s deployment pipelines
- `eversis-managing-secrets` - For K8s secret management patterns
- `eversis-implementing-terraform-modules` - For provisioning K8s clusters
