---
name: eversis-sql-and-database-understanding
...
- `eversis-architecture-designing` — for designing data models as part of broader system architecture
- `eversis-code-reviewing` — for validating SQL quality, index coverage, and query performance
- `eversis-technical-context-discovering` — for establishing database conventions and existing patterns before designing
