---
name: eversis-optimizing-cloud-cost
...
- `eversis-implementing-terraform-modules` - For resource provisioning
- `eversis-designing-multi-cloud-architecture` - For cloud selection
