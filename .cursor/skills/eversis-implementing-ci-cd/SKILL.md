---
name: eversis-implementing-ci-cd
...
**Rule:** Prefer OIDC federation over long-lived access keys. Use `eversis-managing-secrets` skill for implementation details.
...
1. **Discover context** → Use `eversis-technical-context-discovering` to find existing CI patterns
...
5. **Configure credentials** → Use `eversis-managing-secrets` skill
...
- `eversis-managing-secrets` - For credential configuration
- `eversis-technical-context-discovering` - For finding existing patterns
