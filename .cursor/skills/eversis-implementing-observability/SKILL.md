---
name: eversis-implementing-observability
...
- `eversis-implementing-kubernetes` - For K8s-native observability setup
- `eversis-implementing-ci-cd` - For pipeline observability integration
- `eversis-managing-secrets` - For secure credential storage for observability tools
