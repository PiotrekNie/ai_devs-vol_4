...
- `eversis-implementing-frontend` — hooks are used within components; this skill covers component patterns
- `eversis-optimizing-frontend` — for memoization strategies and performance patterns in hooks
- `eversis-reviewing-frontend` — for hook-specific code review criteria
- `eversis-implementing-forms` — for form-related custom hooks (field state, validation triggers)
