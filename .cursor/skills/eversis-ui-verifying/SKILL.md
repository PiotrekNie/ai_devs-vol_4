...
- `eversis-implementing-frontend` - for implementing fixes following design system patterns
- `eversis-technical-context-discovering` - for understanding project's design token conventions
