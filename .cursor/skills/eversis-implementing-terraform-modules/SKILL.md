---
name: eversis-implementing-terraform-modules
...
- `eversis-designing-multi-cloud-architecture` - For architectural decisions
- `eversis-optimizing-cloud-cost` - For cost-effective designs
