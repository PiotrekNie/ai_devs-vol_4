---
name: eversis-designing-multi-cloud-architecture
...
6. **Implement IaC** → Use `eversis-implementing-terraform-modules` skill
...
- `eversis-implementing-terraform-modules` - For IaC implementation
- `eversis-optimizing-cloud-cost` - For cost management
