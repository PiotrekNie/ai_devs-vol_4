---
name: eversis-optimizing-frontend
...
- `eversis-implementing-frontend` — for component patterns that support performant rendering
- `eversis-writing-hooks` — for memoization and cleanup patterns within custom hooks
- `eversis-reviewing-frontend` — for performance-focused code review spot-checks
- `eversis-ensuring-accessibility` — to verify optimizations (lazy-loading, virtualization) don't break keyboard navigation or screen reader access
