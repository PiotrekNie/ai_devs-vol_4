---
name: eversis-implementing-forms
...
Use the `eversis-ensuring-accessibility` skill for a thorough audit. At minimum, verify:
...
- `eversis-implementing-frontend` — for component composition patterns and framework-specific references (form library integration, validation library choice)
- `eversis-ensuring-accessibility` — for WCAG compliance in form fields, labels, and error announcements
- `eversis-writing-hooks` — for custom form-related hooks/composables (useFormField, useMultiStepForm)
- `eversis-reviewing-frontend` — for form-specific review criteria during code review
